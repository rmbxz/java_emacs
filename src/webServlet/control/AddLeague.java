 ...
 *
 *
 * Created: Thu Aug 31 17:21:33 2017
 *
...
public class AddLeague extends HttpServlet {
	...
	try {
		...
		RequestDispatcher view = request.getRequestDispatcher("success_league.view");
		view.forward(request,response);
		return ;
	    } else {
		RequestDispatcher view = request.getRequestDispatcher("failed_league.view");
		view.forward(request,response);
		return ;
	    }
	} catch (Exception e) {
